...
export default function Footer() {
  ...
  return (
    <footer 
      id="footer"
      className="bg-networth-purple text-networth-black"
      aria-label="NetWorth footer"
    >
      {/* Top section with animated logo */}
      <div className="relative py-16 md:py-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 text-center">
          {/* Animated NETWORTH text */}
          <motion.div 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 1 }}
            className="relative h-32 md:h-48 flex items-center justify-center"
            aria-hidden="true"
          >
            {/* Background animated text with stretch effect */}
            <motion.h1 
              className="absolute inset-0 flex items-center justify-center text-6xl md:text-8xl lg:text-9xl font-black uppercase tracking-wider text-networth-black/10"
              animate={{ 
                scaleX: [1, 1.2, 1],
                opacity: [0.1, 0.2, 0.1]
              }}
            ...
            <motion.h1 
              className="relative text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-wider text-networth-black/20 cursor-pointer"
              whileHover={{ 
                scale: 1.05,
          ...
          <motion.p 
            ...
            className="text-lg md:text-xl font-semibold mt-4 text-networth-black/80"
          >
            Measure Your Worth. Master Your Future.
          </motion.p>
        </div>
      </div>

      {/* Bottom section with links */}
      <div className="bg-networth-black text-white">
            ...
            >
              ...
              <ul className="space-y-2">
                {[
                  ...
                  { name: 'X (Twitter)', url: 'https://x.com/networthgame' },
